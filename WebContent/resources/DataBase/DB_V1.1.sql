...
CREATE TABLE IF NOT EXISTS `PosMaster`.`Branch` (
  ...
  PRIMARY KEY (`id`),
  INDEX `FK_BRANCH_ADDRESS_idx` (`address_id` ASC) VISIBLE,
  INDEX `FK_ADMINISTRATOR_idx` (`user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `PosMaster`.`Configuration` (
  ...
  PRIMARY KEY (`id`),
  INDEX `FK_Conf_Address_idx` (`main_address` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `PosMaster`.`Customer` (
  ...
  PRIMARY KEY (`id`),
  INDEX `FK_Detail_Info_idx` (`customer_detail_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `PosMaster`.`Sale` (
  ...
  INDEX `FK_Sale_Account_idx` (`account_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `PosMaster`.`Poduct` (
  ...
  INDEX `FK_Detail_idx` (`detail_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `PosMaster`.`Order` (
  ...
  PRIMARY KEY (`id`),
  INDEX `FK_SALE__idx` (`sale_id` ASC) VISIBLE,
  INDEX `FK_Product_idx` (`stock_id` ASC) VISIBLE,
  CONSTRAINT `FK_SALE_`
    FOREIGN KEY (`sale_id`)
...
CREATE TABLE IF NOT EXISTS `PosMaster`.`Payment` (
  ...
  `account_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `FK_PAY_BRANCH_idx` (`branch_id` ASC) VISIBLE,
  INDEX `FK_PAY_USER_idx` (`user_id` ASC) VISIBLE,
  INDEX `FK_Account_Payment_idx` (`account_id` ASC) VISIBLE,
